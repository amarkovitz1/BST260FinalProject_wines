...
fit <- randomForest(points ~ price + longitude + latitude + 
                      variety + winery + 
                      as.numeric(year) + avgtemp + avgprcp,
                      data=wine_v7_ml, 
                      importance=TRUE, 
                      ntree=500)
...
########Set temp and prec to the mean if missing (missing for a lot of values)
##If time, test whether we predict better if have the full data
